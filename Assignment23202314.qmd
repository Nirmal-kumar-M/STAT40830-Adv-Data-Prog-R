...
This scatter plot displays the relationship between the weight of cars (in thousands of pounds) and their fuel efficiency measured in miles per gallon (MPG), with each point color-coded based on horsepower. The plot reveals several key trends:
